...
ARCHITECT_FNAME varchar(10),
ARCHITECT_LNAME varchar(10),
ARCHITECT_PHONE varchar(10),
ARCHITECT_EMAIL varchar(30),
...
CONTRACTOR_FNAME varchar(10),
CONTRACTOR_LNAME varchar(10),
CONTRACTOR_PHONE varchar(10),
